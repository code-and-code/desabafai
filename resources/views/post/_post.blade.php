        ...
        <div class="col s12 m12">
            <div class="card">
                ...
                <div class="card-content">
                    <p class="secondary-content"><span class="teal-text">{{$post->created_at->diffForHumans()}}</span>
                    </p>
                    <span class="card-title">{{$post->title}}</span>

                    <p>{!! $post->body !!}</p>
                    <a href="https://www.google.com.br/maps/search/{{$post->address}}" target="_blank">
